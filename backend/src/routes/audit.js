...
const ENTITY_PERMISSIONS = Object.freeze({
  ...
  pipeline_opportunity: PERMISSIONS.PIPELINE_VIEW,
  ...
  form_template: PERMISSIONS.FORM_TEMPLATES_VIEW,
  report: PERMISSIONS.REPORTS_VIEW,
  certificate: PERMISSIONS.CERTIFICATES_VIEW,
