...
router.get("/health", (req, res) => {
  res.json({
    ...
    microsoft_sso: "multitenant-invite-only-foundation",
    login_experience: "professional-brand-aware-bilingual",
    tenant_identity: "user-auth-audit-company-boundary-foundation",
    ...
    defects: "defects-corrective-actions-foundation",
    customer_360: "customer-360-activity-documents-foundation",
    commercial: "quotations-contracts-foundation",
    help_centre: "bilingual-plain-language-guides",
    contract_automation: "renewals-recurring-services-work-generation",
    sample_data: "comprehensive-operating-company-demo",
    modules: [
      "CRM",
      "Buildings / Sites",
      "CMMS",
